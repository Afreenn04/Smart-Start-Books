      ...
      <header className="sticky top-0 z-20 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <div className="hidden gap-2 md:flex">
            <Button onClick={() => setActivePortal("student")} className="rounded-2xl px-4 py-2">
              Student
            </Button>
            <Button onClick={() => setActivePortal("parent")} variant="outline" className="rounded-2xl px-4 py-2">
              Parent
            </Button>
            <Button onClick={() => setActivePortal("admin")} variant="outline" className="rounded-2xl px-4 py-2">
              Admin
            </Button>
          </div>
        ...
        <section id="portals" className="mx-auto max-w-7xl px-5 py-12">
            ...
            <Card className="rounded-[2rem] border-0 bg-white shadow-sm">
              <CardContent className="grid gap-6 p-8 md:grid-cols-3">
                <div className="md:col-span-1">
                  <GraduationCap className="mb-4 h-9 w-9" />
                  <h3 className="text-2xl font-black">Student Dashboard</h3>
                  <p className="mt-3 text-slate-600">Children can open lessons, complete quizzes, collect stars, and follow their daily study routine.</p>
                </div>
                <div className="grid gap-4 md:col-span-2 sm:grid-cols-2">
                  {["Continue lesson", "Take quiz", "View rewards", "Check progress"].map((item) => (
                    <div key={item} className="rounded-2xl bg-slate-50 p-5 font-semibold">{item}</div>
                  ))}
                </div>
              </CardContent>
            </Card>
          ...
          {activePortal === "parent" && (
            <Card className="rounded-[2rem] border-0 bg-white shadow-sm">
              <CardContent className="grid gap-6 p-8 md:grid-cols-3">
                <div className="md:col-span-1">
                  <UsersRound className="mb-4 h-9 w-9" />
                  <h3 className="text-2xl font-black">Parent Dashboard</h3>
                  <p className="mt-3 text-slate-600">Parents can review progress, set weekly goals, download worksheets, and support steady study habits.</p>
                </div>
                <div className="grid gap-4 md:col-span-2 sm:grid-cols-2">
          ...
          {activePortal === "admin" && (
            <div className="rounded-[2rem] bg-white p-8 shadow-sm">
              ...
              <div className="mt-8 rounded-3xl bg-slate-50 p-6">
                ...
                <p className="mt-2 text-slate-600">
                  Create a lesson by CfE level, subject and topic. This is a visual form for now; later we will connect it to a database.
                </p>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  ...
                  <select className="rounded-2xl border bg-white px-4 py-3 outline-none">
                    ...
                    <option>Expressive Arts</option>
                    <option>Religious & Moral Education</option>
                  </select>
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  <input className="rounded-2xl border bg-white px-4 py-3 outline-none" placeholder="Estimated time e.g. 20 min" />
                  <input className="rounded-2xl border bg-white px-4 py-3 outline-none" placeholder="Worksheet file name or link" />
                </div>
              ...
              <div className="mt-8 grid gap-6 lg:grid-cols-2">
                <div className="rounded-3xl bg-slate-50 p-6">
                  <h3 className="text-2xl font-black">Recent Admin Tasks</h3>
                  <div className="mt-5 space-y-3">
                    {["Add P4 fractions worksheet", "Review phonics lesson", "Upload reasoning quiz", "Update parent reports"].map((task) => (
                      <div key={task} className="rounded-2xl bg-white p-4 font-medium shadow-sm">
                        {task}
                      </div>
                    ))}
                  </div>
                ...
                <div className="rounded-3xl bg-slate-50 p-6">
                  <h3 className="text-2xl font-black">Curriculum Levels</h3>
                  <div className="mt-5 space-y-3">
                    {["Early Level", "First Level", "Second Level", "11+ Preparation"].map((level) => (
                      <div key={level} className="flex items-center justify-between rounded-2xl bg-white p-4 shadow-sm">
