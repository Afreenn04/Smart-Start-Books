...
function Button({ children, className = "", variant = "", ...props }) {
  return (
    <button
      className={`bg-slate-900 text-white border-none cursor-pointer font-semibold ${
        variant === "outline"
...
const lessons = [
  ...
  {
    title: "Coding: First Steps with Logic",
    age: "Ages 10-13",
    time: "30 min",
    level: "Beginner",
    subject: "Coding",
...
const scottishCurriculum = [
  {
    ...
    age: "Ages 3-6",
    description:
      "For nursery, early learning and childcare, and most children in P1. Learning is play-based, practical, and built around confidence, curiosity, communication and early skills.",
    areas: [
      {
    ...
    areas: [
      {
        name: "Literacy & English",
        topics: [
          "Reading familiar and unfamiliar texts",
      ...
      },
      {
        ...
        topics: [
          "Digital literacy",
          "Simple coding and instructions",
          "Design challenges",
          "Food and textiles",
      ...
      },
      {
        name: "Religious & Moral Education",
        topics: [
          "World religions and celebrations",
          "Values and choices",
          "Respect for beliefs",
          "Moral stories",
  ...
  },
  {
    ...
    age: "Ages 9-12",
    description:
      "For most children in P5, P6 and P7. Learning prepares children for secondary school through deeper understanding, research, reasoning, problem solving and responsibility.",
    areas: [
      {
        name: "Literacy & English",
        topics: [
      ...
      },
      {
        ...
        topics: [
          ...
          "Chemical changes and materials",
      ...
      },
      {
        name: "Social Studies",
        topics: [
          "Scottish, British and world history",
          "Maps, climate and landscapes",
      ...
      },
      {
        name: "Expressive Arts",
        topics: [
          "Art techniques and design",
          "Music composition and performance",
          "Script and drama work",
  ...
  },
  {
    ...
    age: "Ages 9-11",
    description:
      "Not part of Curriculum for Excellence, but useful as an additional preparation pathway for families seeking grammar or independent school entrance practice.",
    areas: [
      {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-20 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Scottish CfE self-study for kids
              </p>
            </div>
          </div>
          ...
          <Button className="hidden rounded-2xl px-4 py-2 md:inline-flex">
            Student Login
          </Button>
      ...
      <main>
        <section className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-16 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="text-4xl font-black tracking-tight md:text-6xl">
              A smart Scottish learning portal for kids to study, practise, and
              grow.
            </h2>

            <p className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
              Create CfE-aligned lessons, simple quizzes, daily routines, and
              progress dashboards so children can build confidence one topic at a
              time.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button className="rounded-2xl px-6 py-4 text-base">
                Start Learning
              </Button>
              <Button variant="outline" className="rounded-2xl px-6 py-4 text-base">
                <PlayCircle className="mr-2 h-5 w-5 inline" /> Watch Demo
              </Button>
            </div>
          </motion.div>
        ...
        <section id="lessons" className="mx-auto max-w-7xl px-5 py-12">
          <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <select
                ...
                className="rounded-2xl border bg-white px-4 py-3 text-sm shadow-sm outline-none"
              >
                {["All", "Maths", "English", "Science", "Coding"].map(
                  (option) => (
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {filteredLessons.map((lesson) => (
              <Card
                key={lesson.title}
                className="rounded-3xl border-0 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
              >
                <CardContent className="p-6">
                  ...
                  <p className="mt-3 text-sm text-slate-500">
                    {lesson.age} • {lesson.time} • {lesson.level}
                  </p>

                  <Button className="mt-6 w-full rounded-2xl py-3">
                    Open Lesson
                  </Button>
                </CardContent>
              </Card>
        ...
        <section
          id="plan"
          className="mx-auto grid max-w-7xl gap-6 px-5 py-12 md:grid-cols-3"
        >
          <Card className="rounded-3xl border-0 bg-slate-900 text-white shadow-lg md:col-span-1">
            <CardContent className="p-7">
              ...
              <p className="mt-3 text-slate-300">
                A calm routine helps children learn independently without feeling
                overwhelmed.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-3xl border-0 bg-white shadow-sm md:col-span-2">
            <CardContent className="grid gap-4 p-7 sm:grid-cols-2">
              {plans.map((plan, index) => (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 font-black">
                    {index + 1}
                  </div>
            ...
            <CardContent className="grid gap-8 p-8 md:grid-cols-2 md:p-12">
              <div>
                ...
                <p className="mt-4 leading-7 text-slate-600">
                  Add learning goals, review quiz results, assign weekly topics,
                  and celebrate consistent effort. Keep the structure simple and
                  familiar so children know exactly what to do each day.
                </p>
              </div>
              ...
              <div className="grid gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-3 rounded-2xl bg-slate-50 p-4 font-semibold"
                  >
        ...
        <section id="curriculum" className="mx-auto max-w-7xl px-5 py-12">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-3xl text-slate-600">
              Organised by CfE levels and the eight curriculum areas used in
              Scottish education. Early Level usually covers Early Years to P1,
              First Level covers P2-P4, and Second Level covers P5-P7. The 11+
              section is included separately because it is not part of CfE.
            </p>
          </div>
          ...
          <div className="space-y-8">
            {scottishCurriculum.map((level) => (
              <Card
                key={level.level}
                className="rounded-[2rem] border-0 bg-white shadow-sm"
              >
                <CardContent className="p-7">
                  <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-start">
                    <div>
                      <p className="text-sm font-bold uppercase tracking-wide text-slate-500">
                        {level.stage} • {level.age}
                      </p>
                    ...
                    <Button className="rounded-2xl px-4 py-3">
                      Build Lessons
                    </Button>
                  </div>
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          {area.topics.map((topic) => (
                            <div
                              key={topic}
                              className="flex items-start gap-2 rounded-2xl bg-slate-50 px-3 py-2 text-sm font-medium text-slate-700"
                            >
